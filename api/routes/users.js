...
router.get("/id/:userId/whiteboards", auth.verifyToken, function (req, res, next) {
    const query =
...
router.get("/id/:email", auth.verifyToken, function (req, res, next) {
...
router.get("/get-name/:userId", auth.verifyToken, function (req, res, next) {
